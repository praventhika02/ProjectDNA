      ...
      <div className="grid gap-5 md:grid-cols-[150px_1fr_150px] md:items-center">
        ...
        <div>
          ...
          <div className="h-4 overflow-hidden rounded-full bg-[#071126]/80 ring-1 ring-white/10">
            <div
              className="h-full rounded-full bg-gradient-to-r from-cyan-400 via-violet-500 to-emerald-400 shadow-[0_0_24px_rgba(34,211,238,0.45)] transition-all duration-500 animate-soft-pulse"
...
function ScoreOrb({ label, score, tone }: { label: string; score: number; tone: "cyan" | "emerald" }) {
  ...
  return (
    <div className="mx-auto text-center">
      <div
        className="flex h-32 w-32 items-center justify-center rounded-full p-1 shadow-[0_0_34px_rgba(34,211,238,0.22)]"
